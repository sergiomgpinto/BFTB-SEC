...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="bftb-library" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" pt.tecnico.bftb.library.BFTBLibraryApp %CMD_LINE_ARGS%
